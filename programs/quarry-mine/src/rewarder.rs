...
mod tests {
    ...
    const DEFAULT_DAILY_REWARDS_RATE: u64 = 71_428_571_428_600;
    ...
    fn test_compute_quarry_rewards_rate_with_multiple_quarries_fixed() {
        ...
        for _ in 0..rewarder.num_quarries {
            let quarry_rewards_share: u32 = rng.gen_range(1..rewarder.daily_rewards_rate as u32);
        ...
        let diff = rewarder.daily_rewards_rate - total_rewards_per_day;
    ...
    proptest! {
        ...
        fn test_compute_rewards_rate_when_total_rewards_shares_is_zero(
            ...
            daily_rewards_rate in 0..u64::MAX,
    ...
    proptest! {
        ...
        fn test_compute_quarry_rewards_rate_with_multiple_quarries(
            daily_rewards_rate in SECONDS_PER_DAY as u64..MAX_REWARDS_RATE,
            num_quarries in 1..MAX_QUARRIES,
        ) {
            let rewarder = &mut Rewarder::default();
            rewarder.daily_rewards_rate = daily_rewards_rate * num_quarries;

            let mut rng = thread_rng();
            let mut quarry_rewards_shares: Vec<u64> = Vec::new();
            for _ in 0..num_quarries {
                let quarry_rewards_share: u32 = rng.gen_range(1..daily_rewards_rate as u32 / 10);
                add_quarry(rewarder, quarry_rewards_share as u64);
                quarry_rewards_shares.push(quarry_rewards_share.into());
            }

            let min_quarry_rewards_share = *quarry_rewards_shares.iter().min().unwrap();
            prop_assume!(rewarder.daily_rewards_rate.checked_mul(min_quarry_rewards_share).is_some());
